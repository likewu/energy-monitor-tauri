...
cd E:\app\julia\energy-monitor-tauri\src-tauri
...
cargo tauri dev
cargo tauri build --no-bundle --target x86_64-pc-windows-gnu  //not ok
cargo tauri build --no-bundle --target x86_64-pc-windows-msvc  //not ok
